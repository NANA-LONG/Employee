...
<div id="page-wrapper">
	 ...
	 <div class="panel panel-default">
		<div class="panel-body">
			<form class="form-inline" method="get" 
				...
				<div class="form-group">
					<label for="reason">奖罚原因</label> 
					 <input type="text" class="form-control" id="number" 
					                   value="${reason}" name="reason" />
				</div>
				<div class="form-group">
					<label for="explains">奖罚说明</label> 
					 <input type="text" class="form-control" id="explains" 
					                   value="${explains}" name="explains" />
				</div>
	...
	<a href="#" class="btn btn-primary" data-toggle="modal" 
	           data-target="#newAwardDialog" onclick="clearAward()">新建</a>
	<div class="row">
		<div class="col-lg-12">
			<div class="panel panel-default">
			...
			<div class="modal-body">
				<form class="form-horizontal" id="new_award_form">
					...
					<div class="form-group">
						...
						奖罚原因</label> 
						<div class="col-sm-10">
							<input type="number" class="form-control" id="new_reason" placeholder="奖罚原因" name="reason" min="0" max="200"/>
						</div>
					</div>
					<div class="form-group">
						...
						奖罚名称</label> 
						<div class="col-sm-10">
							<input type="number" class="form-control" id="new_name" placeholder="奖罚名称" name="name" min="0" max="200"/>
						</div>
					</div>
					<div class="form-group">
						...
						奖罚说明</label> 
						<div class="col-sm-10">
							<input type="number" class="form-control" id="new_explains" placeholder="奖罚说明" name="explains" min="0" max="200"/>
						</div>
					</div>
					<div class="form-group">
						...
						创建时间</label> 
						<div class="col-sm-10">
							<input type="number" class="form-control" id="new_createtime" placeholder="创建时间" name="createtime" min="0" max="200"/>
						</div>
					</div>
				</form>
			</div>
			...
			<div class="modal-body">
				<form class="form-horizontal" id="new_award_form">
					...
					<div class="form-group">
						...
						奖罚原因</label> 
						<div class="col-sm-10">
							<input type="number" class="form-control" id="edit_reason" placeholder="奖罚原因" name="reason" min="0" max="200"/>
						</div>
					</div>
					<div class="form-group">
						...
						奖罚名称</label> 
						<div class="col-sm-10">
							<input type="number" class="form-control" id="edit_name" placeholder="奖罚名称" name="name" min="0" max="200"/>
						</div>
					</div>
					<div class="form-group">
						...
						奖罚说明</label> 
						<div class="col-sm-10">
							<input type="number" class="form-control" id="edit_explains" placeholder="奖罚说明" name="explains" min="0" max="200"/>
						</div>
					</div>
					<div class="form-group">
						...
						创建时间</label> 
						<div class="col-sm-10">
							<input type="number" class="form-control" id="edit_createtime" placeholder="创建时间" name="createtime" min="0" max="200"/>
						</div>
					</div>
				</form>
			</div>
